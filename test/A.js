...
contract('A', function(accounts) {
    ...
    it("Should set factors", async function(){
      let aInstance= await A.new();
      let result=(await aInstance.setFactor.call(100000000,50000000,2,3333)).valueOf();
      let balance=(await aInstance.availableBalanceOf.call(result,88,792,8,0)).valueOf();
